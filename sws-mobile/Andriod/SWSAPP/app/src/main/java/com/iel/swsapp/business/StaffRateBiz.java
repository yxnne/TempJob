...
import com.iel.swsapp.entity.StaffRateItem;
 ...
 * Project Name     : SWSAPP
 * Descriptions     : 员工整体依从率
 */
public class StaffRateBiz {
    private static final String URL_STAFF_RATE_PATH = "rateByStaffSelect.action";

    public static final String RESULT_STAFF = "rate_staff";
     ...
     */
    public void getStaffRateInfoList(final Context context, boolean isOneDay){

        String depart = "";
        if(MyApplication.getCurrentUser().getDepartIds().equals("1")){
            //
            depart = DepartRateActivity.sChooseDepartId;
        }else{
            depart = MyApplication.getCurrentUser().getDepartIds();
        }
        ...
        url.append(URL_STAFF_RATE_PATH).append("?");
        ...
        RxVolley.get(url.toString(), new HttpCallback() {
            ...
            public void onSuccess(String t) {
                ...
                intent.setAction(StaticClass.ACTION_GET_STAFF_RATE);
                Bundle bundle = new Bundle();
                bundle.putSerializable(RESULT_STAFF,resData);
    ...
    public static class StaffRateInfoItem implements Serializable{
        String name,cardno,rate,jobType,department,rank,rfid;
