...
import PCOneTabListComponent from '../components/pc_tab_only_one_list';
...
//产生数据
const leftListData = [];
const fakeNamesForFun = ['蓉蓉', '百合', '璐璐']
for (let i = 0; i < 50; i++) {
  leftListData.push({
    key:i,
    series: i,
    id:`OUT${(i+1)*100}`,
    gastro_name: fakeNamesForFun[ i % 3 ],
  });
}
/*
...
作用 : 内镜追溯 / 患者
*/
export default class PCRetrospectPatientPage extends React.Component{
          ...
          <div className="pages_container_without_breadcrumb" >
            <Layout>
              <Sider width={240} style={{ background: '#fff' }}>
                ...
                <PCOneTabListComponent titleName="使用患者" col1_name="就诊号" col2_name="患者姓名" listData={leftListData}/>
