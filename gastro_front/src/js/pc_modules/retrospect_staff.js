...
//产生数据
const leftListData = [];
const fakeNamesForFun = ['宝强', '羽凡', '乃亮']
for (let i = 0; i < 50; i++) {
  leftListData.push({
    key:i,
    series: i,
...
作用 : 内镜追溯 / 员工
*/
export default class PCRetrospectStaffPage extends React.Component{
          ...
          <div className="pages_container_without_breadcrumb" >
            <Layout>
              <Sider width={240} style={{ background: '#fff' }}>
                ...
                <PCOneTabListComponent titleName="清洗员工" col1_name="员工编号" col2_name="员工姓名" listData={leftListData}/>
